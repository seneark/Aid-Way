...
import { ScrollView, StyleSheet, Image, TouchableWithoutFeedback, ImageBackground, Dimensions, LogBox } from "react-native";
//galio
		...
		return (
			<Block flex style={[styles.group, { paddingBottom: theme.SIZES.BASE * 5 }]}>
				...
				<Block style={{ marginHorizontal: theme.SIZES.BASE * 2 }}>
					<Block flex right>
						<Text size={12} color={theme.COLORS.PRIMARY} onPress={() => navigation.navigate("Home")}>
							View All
						</Text>
					</Block>
